...
python3 -m pip install --upgrade --break-system-packages numpy matplotlib scipy pandas arrow pyarrow pillow chrono ipython jedi neovim argparse termcolor setuptools pkgconfig torch torchvision torchaudio mlxtend scikit-learn scikit-image sympy pyyaml pybind11
